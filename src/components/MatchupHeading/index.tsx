...
const MatchupHeading: React.FC<Props> = ({
    ...
    // The standings column abbreviates at every width; the pick form only does
    // so on a phone. Everywhere else has room for the real name.
    const abbreviateWhen = size === 'grid' ? 'always'
